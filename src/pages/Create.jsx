        ...
        <form className="w-full max-w-lg mx-auto mt-5" onSubmit={addBook}>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    <textarea value={description} onChange={e => setDescription(e.target.value)} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-description" type="text" placeholder="Book Description" />
                </div>
            </div>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <button type="button" onClick={addCategory} className="bg-primary p-1 rounded-lg text-white mb-3">
                ...
                <div className="flex flex-wrap">
                    {
                        categories.map((genre) => (
                            <span key={genre} className="mx-1 my-1 text-white rounded-full px-2 py-1 text-sm bg-primary">{genre}</span>
                        ))
                    }
                </div>
            </div>
